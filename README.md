...
| `to-prd` | Convierte descripciones en lenguaje natural a specs estructuradas |
| `to-issues` | Convierte specs en issues de GitHub / backlog markdown |
| `tdd` | Test-Driven Development para funciones reutilizables |
| `setup-matt-pocock-skills` | Configura el repo para usar el ecosistema de skills |
| `improve-codebase-architecture` | Detecta duplicaciones y propone refactor sin cambiar comportamiento |
| `graphify` | Construye grafo de conocimiento del codebase para navegación y queries |
